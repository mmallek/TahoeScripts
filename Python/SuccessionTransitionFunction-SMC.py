...
def mdc_trans_prob(*args):
    ...
    for label, PS, SL, SY in args:
        ...
        transition_prob[AS >= SL] = 0
        plt.plot(AS, transition_prob, label=label)
    plt.title("Transition Probability for SMC, Mid Development Closed")
    plt.xlabel("Years in Stage")
...
def mdo_trans_prob(*args):
    ...
    for label, PS, SL, SY in args:
        ...
        transition_prob[AS >= SL] = 0
        plt.plot(AS, transition_prob, label=label)
    plt.title("Transition Probability for SMC, Mid Development Open")
    plt.xlabel("Years in Stage")
...
def ldo_trans_prob(*args):
    ...
    for label, PS, SL, SY in args:
        ...
        transition_prob[AS >= SL] = 0
        plt.plot(AS, transition_prob, label=label)
    plt.title("Transition Probability for SMC, Late Development Open")
    plt.xlabel("Years in Stage")
