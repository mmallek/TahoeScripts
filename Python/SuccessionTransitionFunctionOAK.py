...
def md_trans_prob(*args):
    ...
    for label, PS, SY, SL in args:
        ...
        transition_prob[AS >= SL] = 0
        plt.plot(AS, transition_prob, label=label)
    plt.title("Transition Probability for OAK, Mid Development")
    plt.xlabel("Years in Stage")
...
def ldo_trans_prob(*args):
    ...
    for label, PS, SY, SL in args:
        ...
        transition_prob[AS >= SL] = 0
        plt.plot(AS, transition_prob, label=label)
    plt.title("Transition Probability for OAK, Late Development Open")
    plt.xlabel("Years in Stage")
...
def ldc_trans_prob(*args):
    ...
    for label, PS, SY, SL in args:
        ...
        transition_prob[AS >= SL] = 0
        plt.plot(AS, transition_prob, label=label)
    plt.title("Transition Probability for OAK, Late Development Closed")
    plt.xlabel("Years in Stage")
