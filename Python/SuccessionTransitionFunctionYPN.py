...
def ed_trans_prob(*args):
    ...
    plt.title("Transition Probability for YPN, Early Development")
...
def mdc_trans_prob(*args):
    ...
    for label, PS, SY, SL in args:
        ...
        transition_prob[AS >= SL] = 0
        plt.plot(AS, transition_prob, label=label)
    plt.title("Transition Probability for YPN, Mid Development Closed")
    plt.xlabel("Years in Stage")
...
def mdo_trans_prob(*args):
    ...
    for label, PS, SY, SL in args:
        ...
        transition_prob[AS >= SL] = 0
        plt.plot(AS, transition_prob, label=label)
    plt.title("Transition Probability for YPN, Mid Development Open")
    plt.xlabel("Years in Stage")
...
def ldo_trans_prob(*args):
    ...
    for label, PS, SY, SL in args:
        ...
        transition_prob[AS >= SL] = 0
        plt.plot(AS, transition_prob, label=label)
    plt.title("Transition Probability for YPN, Late Development Open")
    plt.xlabel("Years in Stage")
...
def ldc_trans_prob(*args):
    ...
    for label, PS, SY, SL in args:
        ...
        transition_prob[AS >= SL] = 0
        plt.plot(AS, transition_prob, label=label)
    plt.title("Transition Probability for YPN, Late Development Closed")
    plt.xlabel("Years in Stage")
